...
SCRIPTS=(
    ...
    "plotequilibrium --uri \"imas:mdsplus?user=public;pulse=134174;run=117;database=ITER;version=3\" --rho -md \"imas:mdsplus?user=public;pulse=111001;run=103;database=ITER_MD;version=3#pf_active\" \"imas:mdsplus?user=public;pulse=116000;run=4;database=ITER_MD;version=3#wall\" --dd-update --save --directory $LOG_DIR"
    ...
    "plotmachinedescription --uri \"imas:hdf5?user=public;pulse=116000;run=4;database=ITER_MD;version=3\" --dd-update --save --directory $LOG_DIR"
