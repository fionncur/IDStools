...
"idscp --source_uri \"imas:mdsplus?user=public;shot=131024;run=10;database=ITER;version=3\" --destination_uri \"imas:mdsplus?user=$USERNAME;shot=145000;run=5;database=ITER;version=3\"" 
...
"idsresample --input_uri \"imas:mdsplus?user=public;shot=131024;run=10;database=ITER;version=3\" --output_uri \"imas:mdsplus?user=$USERNAME;shot=131024;run=5;database=ITER;version=3\"" 
"idsrescale_equilibrium --input_uri \"imas:mdsplus?user=public;shot=122525;run=1;database=ITER;version=3\" --output_uri \"imas:mdsplus?user=$USERNAME;shot=122222;run=25;database=ITER;version=3\"  --rescale 2" 
...
"idsperf --uri \"imas:mdsplus?user=public;shot=122525;run=1;database=ITER;version=3\" summary --verbose --outputRun 5 --showStats --repeat 2 --uriOut \"imas:mdsplus?user=$USERNAME;shot=131024;run=25;database=ITER;version=3\" --memoryBackend" 
