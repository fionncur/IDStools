...
"idscp --source_uri \"imas:mdsplus?user=public;shot=131024;run=10;database=ITER;version=3\" --destination_uri \"imas:mdsplus?user=$USERNAME;shot=145000;run=2;database=ITER;version=3\"" 
