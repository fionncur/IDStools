...
EB_OPTS="--modules-tool=EnvironmentModules --module-syntax=Tcl --allow-modules-tool-mismatch --allow-use-as-root-and-accept-consequences --prefix=/work/imas/opt/bamboo_deploy/easybuild/"
write_headers_file
