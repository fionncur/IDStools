...
*************************
   ...
   .. code-block:: bash
        ...
        $ plotequilibrium --uri "imas:mdsplus?user=public;pulse=134174;run=117;database=ITER;version=3" --rho -md pf_active wall
   ...
   .. thumbnail:: _static/images/plotequilibrium.png
      :alt: image not found
      :align: center

   .. thumbnail:: _static/images/plotequilibrium2.png
      :alt: image not found
      :align: center
