...
*IDSTools* includes 1. Database tools 2. IDS Tools 3. Plasma Physics
Tools

Advantages:

-  Scripts for daily use of IMAS operations
-  A set of quickly available functions and libraries, as well as an
   additional set of readily available visualization scripts.
