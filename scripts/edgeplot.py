...
ax0.plot(inter.description_2d[0].vessel.unit[0].annular.centreline.r, inter.description_2d[0].vessel.unit[0].annular.centreline.z,'silver')
ax0.set_xlabel('R,m')
ax0.set_ylabel('Z,m')
...
ax1.plot(inter.description_2d[0].vessel.unit[0].annular.centreline.r, inter.description_2d[0].vessel.unit[0].annular.centreline.z,'silver')
ax1.set_xlabel('R,m')
ax1.set_ylabel('Z,m')
...
ax2.plot(inter.description_2d[0].vessel.unit[0].annular.centreline.r, inter.description_2d[0].vessel.unit[0].annular.centreline.z,'silver')
ax2.set_xlabel('R,m')
ax2.set_ylabel('Z,m')
