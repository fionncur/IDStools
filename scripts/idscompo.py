...
from src.framework.view.core_profiles.functions import CoreProfilesView
from src.framework.compute.common.functions import maximum
...
slice_index, ne0 = maximum(ne0_list, 0)
